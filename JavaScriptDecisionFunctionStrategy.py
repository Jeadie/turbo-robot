...
class JavaScriptDecisionFunctionStrategy(AbstractDecisionFunctionStrategy):
    def __init__(self, decisionTreeHandler, functionName, inputs = None, classes = None):
        super(JavaScriptDecisionFunctionStrategy, self).__init__(decisionTreeHandler, functionName)
        self.tab_count = 0
        self.inputs = inputs
