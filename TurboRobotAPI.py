...
class TurboRobotAPI(object):
    ...
    def generate_python_function(data, outputs, name=None, labels=None, classes=None):
        ...
        print(max(classifier.features) +1 , labels)
...
if __name__ == '__main__':
    ...
    print(TurboRobotAPI.generate_python_function(iris.data, iris.target, name="Iris_data_classifier", classes=["'Flower one'", "'Flower two'", "'Flower Three'"], labels=["length", 'height', 'intensity', "count"]))